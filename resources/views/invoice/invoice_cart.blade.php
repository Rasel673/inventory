...
@section('content')
            ...
            <div class="content-page">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="hidden-print">
                                            <div class="pull-right">
                                                ...
                                                <button class="btn btn-primary waves-effect waves-light pull-right" data-toggle="modal" data-target="#invoice_modal">SUBMIT</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div id="invoice_modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
...
@endif
                                            ...
                                            <div class="form-group">
                                                <label for="field-2"  class="control-label" >Payment Type</label>
