                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li>
                                <a href="{{route('pos')}}" class="waves-effect"><i class="fas fa-receipt"></i><span> Pos </span></a>
                            </li>
                            ...
                            <li class="has_sub">
                                <a href="#" class="waves-effect"><i class="md md-palette"></i><span>Supliers </span><span class="pull-right"><i class="md md-add"></i></span></a>
                                <ul class="list-unstyled">
                                    <li><a href="{{ route('add.supliers') }}">Add Supliers</a></li>
                                    <li><a href="{{ route('all.suplier') }}">All Supliers</a></li>
                             ...
                             <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="{{ route('add.salary') }}">Advance Salary</a></li>
                                    <li><a href="{{ route('all.advance') }}">All Advanced</a></li>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><a href="{{ route('import.products') }}">Product Exel </a></li>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><a href="{{route('success.order')}}">Successful Order</a></li>
                                    
                                </ul>
                            </li>
                           <li class="has_sub">
                                <a href="#" class="waves-effect"><i class="md md-palette"></i> <span> Sales </span> <span class="pull-right"><i class="md md-add"></i></span></a>
                                <ul class="list-unstyled">
                                    <li><a href="{{ route('add.expense') }}">Add Sales</a></li>
                                    <li><a href="{{ route('today.expense') }}">Today Sales</a></li>
                                    <li><a href="{{ route('monthly.expense') }}">Monthly Sales</a></li>
                                    <li><a href="{{ route('yearly.expense') }}">Yearly Sales</a></li>
