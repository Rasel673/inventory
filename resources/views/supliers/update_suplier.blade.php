                        ...
                        <div class="row">
                           ...
                           <div class="col-md-8">
                                <div class="panel panel-default">
                                    <div class="panel-heading"><h3 class="panel-title">Update Suplier</h3></div>
...
@endif
                                    <div class="panel-body">
                                        <form role="form" action="{{url('/update-suplier/'.$edit->id)}}" method="post" enctype="multipart/form-data">
                                            @csrf
                                            ...
                                            <div class="form-group">
                                                <label>Suplier Type</label>
                                                <select class="form-control" name="type" >
                                                    <option value="{{$edit->type}}" selected="">{{$edit->type}}</option>
                                                 <option value="distributor">Distributor</option>
                                                 <option value="wholesaler">Wholesaler</option>
                                                 <option value="retailer">Retailer</option></select>

                                                </div>
                                            
                                              <div class="form-group">
                                                <label for="Account Name">Account Name</label>
                                                <input type="text" class="form-control" name="account_holder" required value="{{$edit->account_holder}}">
                                            </div>
                                              <div class="form-group">
