                        ...
                        <div class="col-sm-12">
                            <div class="bg-picture text-center" style="background-image:url('{{URL::to('public/admin/images/big/bg.jpg')}}')">
                                ...
                                <div class="profile-info-name">
                                    <img src="{{URL::to($single->photo)}}" class="thumb-lg img-circle img-thumbnail" alt="suplier-image">
                            ...
                            <div class="tab-pane active" id="home-2"> 
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="panel panel-default panel-fill">
                                            <div class="panel-heading"> 
                                                <h3 class="panel-title">Suplier Information</h3> 
                                            </div> 
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="panel panel-default panel-fill">
                                            <div class="panel-heading"> 
                                                <h3 class="panel-title">Relation</h3> 
                                            </div> 
                                            <div class="panel-body"> 
                                                <div class="m-b-15">
                                                    <h5>2 year<span class="pull-right">60%</span></h5>
                                                    <div class="progress">
